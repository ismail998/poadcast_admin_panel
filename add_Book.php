    ...
    <div id="page-content-wrapper">
            ...
            <form action="dachboard.php" method="POST">
             ...
             <div class="mb-3">
               ...
               <input type="url_img" name ="image"class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
               <div id="emailHelp" class="form-text"></div>
             </div>
             <div class="mb-3">
               <label for="exampleInputEmail1" class="form-label">url audio</label>
               <input type="url_audio" name ="audio"class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
               <div id="emailHelp" class="form-text"></div>
             </div>
             <div class="mb-3">
               <label for="exampleInputEmail1" class="form-label">url book pdf</label>
               <input type="url_pdf" name ="url_pdf" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
               <div id="emailHelp" class="form-text"></div>
             </div>
             <div class="mb-3">
